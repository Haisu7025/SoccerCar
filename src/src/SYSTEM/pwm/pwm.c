...
void TIM3_PWM_Init(u16 arr, u16 psc)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_AFIO, ENABLE); //使能GPIO外设时钟
	GPIO_PinRemapConfig(GPIO_FullRemap_TIM3, ENABLE);

	//输出TIM3 CH3的PWM脉冲波形	GPIOC.6789
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9;		//TIM3_CH3
